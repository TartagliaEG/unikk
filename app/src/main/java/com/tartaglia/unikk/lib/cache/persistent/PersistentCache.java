 ...
 */
public class PersistentCache implements PersistentCacheContract {
  private static final String TAG = PersistentCache.class.getName();
  private final SharedPreferences mPreferences;

  public PersistentCache(SharedPreferences preferences) {
    mPreferences = preferences;
  }

  @Override
  public KeyValueEditable beginTransaction() {
