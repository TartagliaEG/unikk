...
import com.tartaglia.unikk.domain.form.property.Property;
...
public final class FormField<T> extends Property<T> {
  ...
  private ListenerList<FieldValidationListener> mValidationListeners = new ListenerList<>();
  private ListenerList<FieldValidationListener> mValidationListenersForModifiedFields = new ListenerList<>();
  ...
  public final FormField<T> validate() {
    ...
    mValidationListeners.each(new ListenerList.Callback<FieldValidationListener>() {
      @Override
