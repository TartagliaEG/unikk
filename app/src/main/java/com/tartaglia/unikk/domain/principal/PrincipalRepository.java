...
import com.tartaglia.unikk.lib.texthash.TextHashContract;
...
public class PrincipalRepository implements PrincipalContract.Repository {
  ...
  @Inject
  public PrincipalRepository(PersistentCacheContract storage, TextHashContract hashHandler, PrincipalDao dao) {
    mStorage = storage;
